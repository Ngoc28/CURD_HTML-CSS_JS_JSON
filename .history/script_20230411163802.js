    ...
    saveUpdateBtn.onclick = function() {
        ...
        fetch(productsApi + '/' + id, options)
            ...
            .then(function() {
                ...
                document.querySelector('input[name="title"]').textContent = inputPriceEdit.value;

                var inputDescriptionEdit = document.querySelector('input[name="descriptionEdit"]');
                document.querySelector('input[name="title"]').textContent = inputDescriptionEdit.value;
