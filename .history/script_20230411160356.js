...
function handleUpdateProduct(id) {    
    ...
    inputImageEdit.value = document.querySelector(`.product-item${id} .product-img`).textContent;
    
    var inputPriceEdit = document.querySelector('input[name="priceEdit"]');
    inputPriceEdit.value = document.querySelector(`.product-item${id} .product-price`).textContent;

    var inputDescriptionEdit = document.querySelector('input[name="descriptionEdit"]');
    inputDescriptionEdit.value = document.querySelector(`.product-item${id} .product-description`).textContent;
    ...
    saveUpdateBtn.onclick = function() {
        ...
        fetch(productsApi + '/' + id, options)
            ...
            document.querySelector(`.product-item${id} .product-img`).textContent = inputImageEdit.value
            document.querySelector(`.product-item${id} .product-price`).textContent = inputPriceEdit.value
            document.querySelector(`.product-item${id} .product-description`).textContent = inputDescriptionEdit.value
