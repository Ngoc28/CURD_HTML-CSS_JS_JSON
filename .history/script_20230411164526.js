...
function handleUpdateProduct(id) {    
    ...
    document.querySelector(`product-item-${id} .product-img`).innerHTML = inputImageEdit.value;
    ...
    document.querySelector(`product-item-${id} .product-descriptionEdit`).innerHTML = inputDescriptionEdit.value;
    ...
    saveUpdateBtn.onclick = function() {
        ...
        fetch(productsApi + '/' + id, options)
            ...
            .then(function() {
                ...
                document.querySelector('input[name="title"]').innerHTML = inputPriceEdit.value;
                document.querySelector('input[name="title"]').innerHTML = inputDescriptionEdit.value;
