...
function handleUpdateProduct(id) {    
    ...
    inputTitleEdit.value = document.querySelector(`.product-item${id} .product-name`);
    console.log(inputTitleEdit.value)

    // console.log(title)

    var inputImageEdit = document.querySelector('input[name="imageEdit"]');
    inputImageEdit.value = document.querySelector(`.product-item${id} .product-img`);
    
    var inputPriceEdit = document.querySelector('input[name="priceEdit"]');
    inputPriceEdit.value = document.querySelector(`.product-item${id} .product-price`);

    var inputDescriptionEdit = document.querySelector('input[name="descriptionEdit"]');
    inputDescriptionEdit.value = document.querySelector(`.product-item${id} .product-description`);
    ...
    saveUpdateBtn.onclick = function() {
        ...
        fetch(productsApi + '/' + id, options)
            ...
            document.querySelector(`.product-item${id} .product-name`) = inputTitleEdit.value;
            document.querySelector(`.product-item${id} .product-img`) = inputImageEdit.value
            document.querySelector(`.product-item${id} .product-price`) = inputPriceEdit.value
            document.querySelector(`.product-item${id} .product-description`) = inputDescriptionEdit.value
