    ...
    var htmls = products.map(function(product) {
        ...
        <div class="product product-item-${product.id}">
            ...
            <div class="btn">
                ...
                <button onclick="handleUpdateProduct(${product.id})" class="" >Update</button>   
                <button type="button" data-id=${product.id} class="btn btn-edit btn-sm btn-outline-secondary update-btn"
            >
              Edit
            </button>
                <button type="button"  class="update-btn" id="update">Update</button>   
