...
function handleUpdateProduct(id,title, image, price,  description) {    
    ...
    updateBtn = function() {
        let data = {
            titleEdit: inputtitleEdit.value,
            imageEdit: inputImageEdit.value,
            priceEdit: inputPriceEdit.value,
            descriptionEdit: inputDescriptionEdit.value,
        };
        var options = {
            method: 'PUT',
            body: JSON.stringify(data),
        ...
        fetch(productsApi + '/' + id, options)
            ...
            .then(function() {
                ...
                imageEdit.value = title;;
                priceEdit.value = title;;
                descriptionEdit.value = title;;
