...
function renderProducts(products) {
    ...
    listProducts.textContent = htmls.join('');
}
...
function handleUpdateProduct(id) {    
    ...
    inputDescriptionEdit.value = document.querySelector(`product-item-${id} .product-descriptionEdit`).textContent ;
    ...
    saveUpdateBtn.onclick = function() {
        ...
        fetch(productsApi + '/' + id, options)
            ...
            .then(function() {
                ...
                document.querySelector(`product-item-${id} .product-name`).textContent = inputImageEdit.value;
