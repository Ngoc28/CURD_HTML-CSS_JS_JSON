...
function handleUpdateProduct(id) {    
    ...
    inputTitleEdit.value = document.querySelector('input[name="title"]').textContent;
    console.log(inputTitleEdit.value)
    
    

    var inputImageEdit = document.querySelector('input[name="imageEdit"]');
    inputImageEdit = document.querySelector(`.product-item${id} .product-img`);
    
    var inputPriceEdit = document.querySelector('input[name="priceEdit"]');
    inputPriceEdit = document.querySelector(`.product-item${id} .product-price`);

    var inputDescriptionEdit = document.querySelector('input[name="descriptionEdit"]');
    inputDescriptionEdit = document.querySelector(`.product-item${id} .product-description`);
    ...
    saveUpdateBtn.onclick = function() {
        ...
        fetch(productsApi + '/' + id, options)
            ...
            .then(function() {
                getProducts()
                document.querySelector(`.product-item${id} .product-name`) = inputTitleEdit;
